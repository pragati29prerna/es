...
mqueue= mq_open("/mqueue",O_WRONLY|O_CREAT,S_IRUSR|S_IWUSR,&myqueue_attr); //Open the queue to send messages only.
mq_send(mqueue,"HELLO",7,0);//send message to prog 1
